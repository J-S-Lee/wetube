...
function handleProgressBar() {
  progressRange.max = Math.floor(videoPlayer.duration);
  progressRange.value = videoPlayer.currentTime;
  getCurrentTime();
}

function handleProgessBarClick(event) {
...
function init() {
  ...
  progressRange.addEventListener('click', handleProgessBarClick);
}
